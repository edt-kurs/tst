...
Процедура ПолучитьПутьКФайлуНачалоВыбора(РежимДиалога, ПутьКФайлу, ИмяФайла = "")
	...
	ДиалогВыбораФайла.Фильтр                      = НСтр("ru='Книга Excel 2001 (*.xls)|*.xls'");
	ДиалогВыбораФайла.Заголовок                   = "Выбор файла Excеl для загрузки данных";
...
Процедура ЗагрузитьИзФайлаНаСервере(АдресХранилища, РасширениеФайла)
	...
	Если РасширениеФайла = "xls" Тогда
